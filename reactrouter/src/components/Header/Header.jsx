...
//we use link not anchor tag

function Header() {
  return (
    // navlink is same as link but just one extra feature of isactive 
                ...
                <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        >
                          ...
                          <li>
                              <NavLink to="/github"// jo router ke andar diye ha vhi yaha per ayge 
                                  className={({ isActive }) =>
                                      `block py-2 pr-4  ${isActive ? "text-orange-700" : "text-gray-700"} pl-3 duration-200 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 hover:text-orange-700 lg:p-0`
                                  }
                              >
