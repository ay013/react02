...
function Header() {
  return (
        ...
        <div className='max-w-7xl'> <nav className="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <div className="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                      ...
                      <li>
                          ...
                          <li>
                              <NavLink
                                  to="/pricing"
                              className={({ isActive }) => `block py-2 px-3 md:p-0 ${isActive ? "text-orange-600": "text-gray-600"} text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700   dark:hover:text-white md:dark:hover:bg-transparent`
                                  }
                                  Pricing>
                              </NavLink>
                          </li>
